...
else _key_code_compute_oneval_2x1_1x0(1, 8)		\
else _key_code_compute_oneval_2x1_1x0(2, 9)		\
else _key_code_compute_oneval_2x1_1x0(3, 10)		\
else _key_code_compute_oneval_2x1_1x0(4, 11)		\
else _key_code_compute_oneval_2x1_1x0(5, 12)		\
else _key_code_compute_oneval_2x1_1x0(6, 13)		\
else _key_code_compute_oneval_2x1_1x0(7, 14)		\
else _key_code_compute_oneval_2x1_1x1(1, 15)		\
else _key_code_compute_oneval_2x1_1x1(2, 16)		\
else _key_code_compute_oneval_2x1_1x1(3, 17)		\
else _key_code_compute_oneval_2x1_1x1(4, 18)		\
else _key_code_compute_oneval_2x1_1x1(5, 19)		\
else _key_code_compute_oneval_2x1_1x1(6, 20)		\
else _key_code_compute_oneval_2x1_1x1(7, 21)		\
